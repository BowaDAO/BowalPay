...
const Hero = () => {
  return (
    <header className="grid place-items-center py-20">
      <article className="flex flex-col items-center justify-center text-center gap-12 max-w-[45%]">
        ...
        <h5 className="tracking-wide text-lg font-medium leading-relaxed">
          The BowalPay multi-currenct has everything your business needs to pay,
        ...
        <StyledLink
          ...
          extraButtonClasses="rounded-full py-3 px-12 bg-black"
        />
      </article>
    </header>
  );
